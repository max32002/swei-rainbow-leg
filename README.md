...
@font-face {
  ...
  src: url(https://github.com/max32002/swei-rainbow-leg/raw/master/WebFont/CJK%20TC/SweiRainbowLegCJKtc-Regular.woff2) format("woff22")
  , url(https://github.com/max32002/swei-rainbow-leg/raw/master/WebFont/CJK%20TC/SweiRainbowLegCJKtc-Regular.woff) format("woff");
}
```

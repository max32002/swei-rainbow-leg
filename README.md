...
獅尾彩虹腿基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)的上半邊變圓改造，更加簡明現代化的字體。支援简体中文、繁體中文、韓文與日文；可以免費商用，歡迎大家自由應用、自由優化、自由改作！
...
和思源黑體一樣，支援7種的字重：
![字體比較預覽](https://github.com/max32002/swei-rainbow-leg/raw/master/preview/compare_style.png)
...
### 「CJK TC」和「CJK SC」的比較：
![TC和SC比較](https://github.com/max32002/swei-rainbow-leg/raw/master/preview/compare_tc_sc.png)
...
### 「CJK TC」和「CJK JP」的比較：
![TC和SC比較](https://github.com/max32002/swei-rainbow-leg/raw/master/preview/compare_tc_jp.png)
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-rainbow-leg/blob/master/change_log.md) 查看更新記錄。
...
```
@font-face {
  font-family: SweiRainbowLegCJKtc-Regular;
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-rainbow-leg@2.0/WebFont/CJK%20TC/SweiRainbowLegCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-rainbow-leg@2.0/WebFont/CJK%20TC/SweiRainbowLegCJKtc-Regular.woff) format("woff");
}
```
